...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        // Demo logic for fetching name/fname skipped for brevity as it's inside
        // ItemListener mostly,
        // but initial load might fail. Adding robust block for initial load:
        try {
            Conn c = new Conn();
            if (c.s != null) {
        ...
        // Background Image
        try {
            ImageIcon i1bg = new ImageIcon(ClassLoader.getSystemResource("icons/fee.jpg"));
            Image i2bg = i1bg.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
            ImageIcon i3bg = new ImageIcon(i2bg);
            JLabel imagebg = new JLabel(i3bg);
            imagebg.setBounds(0, 0, 900, 500);
            add(imagebg);
        } catch (Exception e) {
        }
